...
//[Authorize(ProductOrderPermissions.Stok.Default)]
public class StokAppService : ProductOrderAppService, IStokAppService
{
    ...
    //[Authorize(ProductOrderPermissions.Stok.Create)]
    ...
    //[Authorize(ProductOrderPermissions.Stok.Update)]
    ...
    /// <Özet>
    /// CheckUpdateAsync ile Manager sınıfından database kontrolü yapılır.
    //[Authorize(ProductOrderPermissions.Stok.Delete)]
