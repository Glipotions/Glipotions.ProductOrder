...
//[Authorize(ProductOrderPermissions.Birim.Default)]
public class BirimAppService : ProductOrderAppService, IBirimAppService
{
    ...
    //[Authorize(ProductOrderPermissions.Birim.Create)]
    ...
    //[Authorize(ProductOrderPermissions.Birim.Update)]
    ...
    /// <Özet>
    /// CheckUpdateAsync ile Manager sınıfından database kontrolü yapılır.
    //[Authorize(ProductOrderPermissions.Birim.Delete)]
