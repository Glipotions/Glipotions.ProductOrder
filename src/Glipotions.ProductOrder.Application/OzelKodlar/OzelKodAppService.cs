...
//[Authorize(ProductOrderPermissions.OzelKod.Default)]
public class OzelKodAppService : ProductOrderAppService, IOzelKodAppService
{
    ...
    //[Authorize(ProductOrderPermissions.OzelKod.Create)]
    ...
    //[Authorize(ProductOrderPermissions.OzelKod.Update)]
    ...
    /// <Özet>
    /// CheckUpdateAsync ile Manager sınıfından database kontrolü yapılır.
    //[Authorize(ProductOrderPermissions.OzelKod.Delete)]
