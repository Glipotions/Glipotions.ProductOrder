...
//[Authorize(ProductOrderPermissions.Donem.Default)]
public class DonemAppService : ProductOrderAppService, IDonemAppService
{
    ...
    //[Authorize(ProductOrderPermissions.Donem.Create)]
    ...
    //[Authorize(ProductOrderPermissions.Donem.Update)]
    ...
    /// <Özet>
    /// CheckUpdateAsync ile Manager sınıfından database kontrolü yapılır.
    //[Authorize(ProductOrderPermissions.Donem.Delete)]
