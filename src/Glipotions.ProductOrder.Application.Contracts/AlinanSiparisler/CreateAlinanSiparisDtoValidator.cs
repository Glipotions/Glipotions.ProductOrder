...
/// </summary>
public class CreateAlinanSiparisDtoValidator : AbstractValidator<CreateAlinanSiparisDto>
{
    /// <ÖZET>
    /// (2/5) Kurs
    ...
    public CreateAlinanSiparisDtoValidator(IStringLocalizer<ProductOrderResource> localizer)
    {

        RuleFor(x => x.AlinanSiparisNo)
            .NotEmpty()
